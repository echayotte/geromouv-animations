    ...
    <section>
        <div class="registration-form">
            <form action="{{ action('MemberController@store') }}" method="post">
                @csrf
                <p>
                    <strong>Les champs marqués avec un astérisque <span class="mandatory">*</span> sont <span class="mandatory">obligatoires</span></strong>
                    <br>
                    <em>
                ...
                <div class="row">
                    ...
                    <div class="col-65">
                        <label for="member-gender">Homme</label>
                ...
                <div class="row">
                    ...
                    <div class="col-65">
                        ...
                        <label>
                            <input type="checkbox" name="member-activities[]" value="{{$activity->id}}"
                            {{ (is_array(old('member-activities')) and in_array($activity->id, old('member-activities'))) ? ' checked' : '' }}>{{$activity->name}}
                        </label>
                        <br>
                        @endforeach
